...
\begin{document}
  ...
  \section{Arbitrary s.p.d. metric}
    ...
    \subsection{Hodge star \( * \)}
      ...
      \begin{itemize}
        ...
        \item \( *\alpha = \sqrt{|g|}\left( -\left( a_{1}g^{12} + a_{2}g^{22} \right)dx^{1} 
                                            +\left( a_{1}g^{11} + a_{2}g^{21} \right)dx^{2}\right) \)
    ...
    \subsection{Rising and lowering indices \( \sharp \) / \( \flat \)}
      ...
      \begin{itemize}
        \item \( \alpha^{\sharp} = \left( g^{11}a_{1}+g^{12}a_{2} \right)\partial_{1} + \left( g^{21}a_{1}+g^{22}a_{2} \right)\partial_{2}\)
        \item \( a^{\mu} = g^{\mu\nu}a_{\nu}\) (\textbf{Ricci})
        \item \( \vecflat{v} = \left( g_{11}v^{1} + g_{12}v^{2} \right)dx^{1} + \left( g_{21}v^{1} + g_{22}v^{2} \right)dx^{2} \)
        \item \( v_{\mu} = g_{\mu\nu}v^{\nu} \) (\textbf{Ricci})
      \end{itemize}
