  ...
  \section{Tensors}
    ...
    \subsection{Covariant Derivative \( \nabla_{\bullet} = g_{\bullet i}\nabla^{\bullet} \)}
      \begin{itemize}
        ...
        \item \( \nabla_{k}\sqrt{|g|} =\sqrt{|g|}\christoffel{k}{l}{l}  \)
        ...
        \item \( \nabla*\alpha = -E\nabla\alpha^{\sharp} \)
              \( \leadsto \) \( (*\alpha)_{i|k} = -E_{ij}\sftensor{\alpha}{j}{|k} \)
        \item \( *\nabla_{\beta}\alpha = \nabla_{\beta}*\alpha \)
        \item \( \nabla (\alpha\otimes\beta) = \alpha\otimes\nabla\beta + \left(\beta\otimes\nabla\alpha\right)^{T} \)
              , (\( t^{T}_{ijk} = t_{jik} \))
              ,\( \leadsto \) \( (\alpha_{i}\beta_{j})_{|k} = \alpha_{i}\beta_{j|k} + \beta_{j}\alpha_{i|k} \)
        \item \( \Rot(f) = -\frac{1}{\sqrt{|g|}}g_{ik}\epsilon^{kl}\partial_{l}fdx^{i}
                         =  -\frac{1}{\sqrt{|g|}}g\epsilon\exd f
                         = -\sqrt{|g|}\epsilon\nabla f
                         = - E\cdot\nabla f\)
