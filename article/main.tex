...
\section{Discrete Exterior Calculus (DEC)}
  ...
  \subsection{DEC operators}
    ...
    \subsubsection{The discrete Laplace-Beltrami operator}
    ...
    \subsubsection{The discrete gradient}
      ...
      In \cite{hirani} it is suggested to use this discrete sharp operator for such a exact \mh{1}{form} \( \exd f \) to get a discrete
      gradient:
      \begin{align}
