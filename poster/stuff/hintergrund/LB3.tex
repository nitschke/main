\begin{tikzpicture}[>=latex, line width=1pt, scale=0.9,dotted]
  % Coords
...
\draw[red,->,solid] (CC0) -- (CC1);
\draw[red,->,solid] (CC1) -- (CC2);
\draw[red,->,solid] (CC2) -- (CC3);
\draw[red,->,solid] (CC3) -- (CC4);
\draw[red,->,solid] (CC4) -- (CC5);
\draw[red,->,solid] (CC5) -- (CC0);
%\draw (C12) -- (CC1);
%\draw (C25) -- (CC2);
%\draw (C56) -- (CC3);
%\draw (C46) -- (CC4);
