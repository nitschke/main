...
\section{Primär- und Dualgitter}
  ...
  \subsection{Umkreismittelpunktunterteilung}
    ...
    \(\left[ c(\sigma^{0}),\ldots,c(\tilde{\sigma}^{i}), \ldots, c(\sigma^{p}) \right] \) ändern, dann würde sich auch bei 
...
\label{secGittergenerierung}
  ...
  \subsection{Beispiele}
    ...
    \subsubsection{Lokale Verfeinerung}
      ...
      Nachdem die neuen Knoten auf die Mannigfaltigkeit projiziert werden ist im Allgemeinen noch nicht sichergestellt, dass ein wohlzentrierte
