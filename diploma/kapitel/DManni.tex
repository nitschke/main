...
\section{Primal- und Dualkomplex}
  ...
  \subsection{Simplizialkomplex}
    ...
    Für \( p \ge 0 \) ergeben sich somit genau 2 Äquivalenzklassen und somit Orientierungen pro Simplex. 
    ...
    \begin{definition}
      ...
      dann definiert sich eine induzierte Orientierung für die Facetten von \( \sigma^{p} \) durch
      \begin{align}
    ...
    \begin{beispiel}
      ...
      \begin{minipage}{0.65\textwidth}
        ...
        dass die Rechte-Hand-Regel gilt und die Fläche per Definition eine äußere Normale besitzt.
