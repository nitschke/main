...
\section{Primal- und Dualkomplex}
  ...
  \subsection{Simplizialkomplex}
    ...
    \begin{definition}
      Ein Simplizialkomplex \( K \) über \( \R^{n} \) ist eine Menge von Simplizes, so dass
      \begin{itemize}
        \item Jede Facette eines Simplexes aus \( K \) ist ebenfalls aus \( K \).
        \item Der Schnitt zweier Simplizes aus \( K \) ist entweder eine Facette von einem der beiden oder leer.
      \end{itemize}
