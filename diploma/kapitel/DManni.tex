...
\section{Kettenkomplexe}
  ...
  \begin{definition}
     ...
     \end{align}
     mit \( s_{\sigma^{p}, \sigma^{p+1}, \ldots, \sigma^{n}}:= \sgn_{\sigma^{p}} \left( \left[ c(\sigma^{p}), c(\sigma^{p+1}), \ldots, c(\sigma^{n}) \right] \right) \) die
     durch \( \sigma^{p} \) induzierte Orientierung für das entsprechende elementare Dualsimplex.
  \end{definition}
