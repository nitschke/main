...
\section{Primal- und Dualkomplex}
  ...
  \begin{ziel}
    ...
    Mannigfaltigkeit welche durch Polyeder diskretsiert wird. Die diskreten Differentialformen sind dann auf den Knoten, Kanten, Flächen usw.
    ...
    eine algebraische Topologie bekommen. Somit wird eine algebraische Struktur erzeugt wird, die es einem ermöglicht in dieser Topologie
    "`sinnvoll zu rechnen"'.
  \end{ziel}
