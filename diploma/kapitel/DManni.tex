...
\section{Kettenkomplexe}
  ...
  Speziell werden wir uns das noch für \( \mathfrak{A} = C_{q}(\csd K) \), \( C_{q}(K) \) oder \( \R \) zunutze machen. \todo{noch mehr?}
  ...
  \begin{folgerung}
    Der (duale) Randoperator \( \partial_{p}: C_{p}(\star K) \rightarrow C_{p-1}(\star K) \) lässt sich vom obigen Randoperator ableiten, 
  ...
  \begin{proof}
    ...
    Die beiden sich ergeben dualen Simplizes sind gegensätzlich orientiert, da die "`Zählrichtung"' der Dualecken anders herum ist.
    \eqref{eqproof4} folgt daraus, dass sich beide Summanden für \( i=k \) auifheben. 
