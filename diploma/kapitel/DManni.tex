...
\section{Primal- und Dualkomplex}
  ...
  \subsection{Simplizialkomplex}
    ...
    \begin{definition}
      ...
      Die Topologie von \( |K| \) ist dann gerade die induzierte Teilraum Topologie des \( \R^{N} \).
      \todo{evtl. wenn nötig auf die besonderheit dass ecken keine offenen mengen sind hinweisen}
    \end{definition}
    
    Meißtens sieht es aber so aus, dass wir ein Raum haben und ein Simplizialkomplex suchen der diesen beschriebt.
    ...
    Bisher beschreibt solch ein Simplizialkomplex noch alle möglichen Teilräume des \( \R^{N} \). 
    ...
    \begin{bemerkung}
      ...
      \begin{itemize}
        \item Falls \( |K| \) nicht flach ist, dann ist \( |K| \) global nicht differenzierbar.
