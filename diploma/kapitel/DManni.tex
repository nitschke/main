...
\section{Primär- und Dualgitter}
  ...
  \begin{ziel}
    ...
    Dazu sind aber einige Voraussetzungen an das Gitter nötig, die hier eingeführt werden.
  ...
  \subsection{Simplizialkomplex}
    ...
    \begin{folgerung}
      ...
      \begin{proof}
        Es seien 2 Simplizes gegeben mit \( \sigma_{1} := v v_{1} v_{2} \) und \( \sigma_{2} := w v_{1}
        v_{2} \).\\
        \begin{minipage}{0.65\textwidth}
