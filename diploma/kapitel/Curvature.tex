...
\label{secWeingartenabbildung}
 ...
 g \) (1. Fundamentalform).
  ...
  definiert ist. 
  Dazu definieren wir eine erweiterte Weingartenabbildung in diesen Koordinaten
  \begin{definition}
  ...
  \end{definition}
  Die erweiterte Weingartenabbildung eingeschränkt auf \( M \) in lokalen Koordinaten ist dann gerade \( S \),
  ...
  \subsection{Implementierung}
    ...
    Deshalb mitteln wir wieder über einen 1-Ring des \( i \)-ten Primärgitterpunktes zu
    \begin{align}
      \left\langle \vec{\nu}, v_{i} \right\rangle 
          := \frac{1}{\left| \star v_{i} \right|} \sum_{\sigma^{2}\succ v_{i}} \left| \star v_{i} \cap \sigma^{2}\right| 
                      \left\langle \vecover{\nu}{\sigma^{2}}, \star\sigma^{2} \right\rangle \formpunkt
    \end{align}
