...
\section{Gauß-Bonnet-Operator}
  ...
  \subsection{Implementierung}
    ...
    \end{align}
    Insgesamt erhalten wir also für die Summe der Außenwinkel der Voronoizelle \( \star v \)
    \begin{align}
...
\label{secNumEx}
  ...
  Die maximalen Fehler befinden sich hier dort, wo die Krümmung am stärksten ist und zudem die
