...
\section{Äußere Ableitung}
  ...
  \begin{folgerung}
    ...
    Des Weiteren ist mit dieser Notation Definition \ref{defAeussereAbleitung} representantenunabhängig (Wohldefiniertheit).
    Es sei \( \alpha_{1},\alpha_{2} \in \Omega^{p}(M) \) mit \( \psi(\alpha_{1}) = \psi(\alpha_{2}) \), 
  ...
  \begin{bemerkung}
    ...
    \begin{tabular}{|c|c|} \hline
      ...
      \begin{minipage}[c]{0.69\textwidth}
        {\begin{align}
          \left\langle \exd f , \sigma^{1} \right\rangle &= f(v_{1}) - f(v_{0})
        \end{align}}
      \end{minipage} \\\hline
      \begin{minipage}[c]{0.29\textwidth}
      ...
      \begin{minipage}[c]{0.69\textwidth}
        {\begin{align}
          \left\langle \exd f , \star\sigma^{1} \right\rangle &= f(c(\sigma^{2}_{2})) - f(c(\sigma^{2}_{1}))
        \end{align}}
      \end{minipage} \\\hline
    \end{tabular}
  \end{bemerkung}
