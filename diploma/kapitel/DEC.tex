...
\section{Laplace-Operator}
  ...
  \subsection{Laplace-Beltrami-Operator}
    ...
    \begin{bemerkung}
      Der in \eqref{eqDiskreteLaplace} beschriebene diskrete Laplace-Operator ist schon länger bekannt.
      In \cite{arakawa} wurde er zum Beispiel schon auf einer quasi-uniform triangulierten Sphäre benutzt.

      cotandorm \cite{meyer}
