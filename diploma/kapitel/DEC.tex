...
\section{Hodge-Stern-Operator}
  ...
  \begin{lemma}
    ...
    \begin{align}
      ...
      \left| (*\psi(\alpha))(\star\sigma^{p}) - \psi(*\alpha)(\star\sigma^{p})\right| \le \mathcal{O}(|\sigma^{p}||\star\sigma^{p}|) \formpunkt
    \end{align}
    \todo[inline]{mit h ändern}
  \end{lemma}
  \begin{proof}
    ...
    Dazu nutzen wir ein Schritt Taylor für die Koordinatenfunktion: 
    \begin{align}
      &\left| |\sigma^{p}|\alpha_{1 \ldots p}(c) - \psi(\alpha)(\sigma^{p})\right| \\
      &=  \left| |\sigma^{p}|\alpha_{1 \ldots p}(c) 
                  - \int_{\sigma^{p}} \alpha_{1 \ldots p}(c) + (x-c)^{T}\nabla\alpha_{1 \ldots p}(c) + \mathcal{O}(h_{\sigma^{p}}^{2}) dx^{1}\wedge\ldots\wedge dx^{p} \right| \\
      &= \left| \int_{\sigma^{p}}  (x-c)^{T}\nabla\alpha_{1 \ldots p}(c) dx^{1}\wedge\ldots\wedge dx^{p} + \mathcal{O}(h_{\sigma^{p}}^{2})\right| \\
      &\le \int_{\sigma^{p}} \left| (x-c)^{T}\nabla\alpha_{1 \ldots p}(c) \right| dx^{1}\wedge\ldots\wedge dx^{p} +|\sigma^{p}| |\mathcal{O}(h_{\sigma^{p}}^{2})| \\
      &\le \int_{\sigma^{p}} \|x-c\|\|\nabla\alpha_{1 \ldots p}(c)\| dx^{1}\wedge\ldots\wedge dx^{p} +|\sigma^{p}| |\mathcal{O}(h_{\sigma^{p}}^{2})| \formtext{\footnotesize(Cauchy-Schwarz)}\\
      &\le \|\nabla\alpha_{1 \ldots p}(c)\| \int_{\sigma^{p}} h_{\sigma^{p}}^{2}  dx^{1}\wedge\ldots\wedge dx^{p} +|\sigma^{p}| |\mathcal{O}(h_{\sigma^{p}}^{2})| \\
      &\le |\sigma^{p}| \left( \|\nabla\alpha_{1 \ldots p}(c)\| h_{\sigma^{p}} + |\mathcal{O}(h_{\sigma^{p}}^{2})| \right) \label{eq1}
    \end{align}
    ...
    \begin{align}
      \left| (*\psi(\alpha))(\star\sigma^{p}) - |\star\sigma^{p}|\alpha_{1 \ldots p}(c) \right|
            ...
            &\le  |\star\sigma^{p}| \left( \|\nabla\alpha_{1 \ldots p}(c)\| h_{\sigma^{p}} + |\mathcal{O}(h_{\sigma^{p}}^{2})| \right)
    \end{align}
    Für die Dualzelle \( \star\sigma^{p} \) können wir die Abschätzung \eqref{eq1} ebenfalls nutzen.
    ...
    \begin{align}
      S_{\sigma^{p}} &:= \left\{ \hat\sigma^{n-p}\in\csd K \middle| \sum_{\hat\sigma^{n-p}\cap\star\sigma^{p} \neq \emptyset}\hat\sigma^{n-p} = \star\sigma^{p} \right\}
      \formpunkt
    \end{align}
    Damit ergibt sich für alle \( \hat\alpha\in\Omega(|K|)=\Omega(|\csd K|) \)
    \begin{align}
      \left| |\star\sigma^{p}|\hat\alpha_{1 \ldots p}(c) - \psi(\hat\alpha)(\star\sigma^{p})\right| 
          &= \left| \sum_{\hat\sigma^{n-p}\in S_{\sigma^{p}}}|\hat\sigma^{n-p}|\hat\alpha_{1 \ldots p}(c) 
                  - \sum_{\hat\sigma^{n-p}\in S_{\sigma^{p}}} \int_{\hat\sigma^{n-p}}\hat\alpha\right| \\
          &\le \sum_{\hat\sigma^{n-p}\in S_{\sigma^{p}}} \left||\hat\sigma^{n-p}|\hat\alpha_{1 \ldots p}(c) - \psi(\hat\alpha)(\hat\sigma^{n-p}) \right| \\
          &\le \sum_{\hat\sigma^{n-p}\in S_{\sigma^{p}}} |\hat\sigma^{n-p}| \left( \|\nabla\hat\alpha_{1 \ldots p}(c)\| 2 h_{\hat\sigma^{n-p}} + |\mathcal{O}((2h_{\hat\sigma^{n-p}})^{2})|
          \right) \\
           &\le |\star\sigma^{p}| \left( \|\nabla\hat\alpha_{1 \ldots p}(c)\| h_{\d\sigma^{p}} + |\mathcal{O}(h_{\sigma^{p}}^{2})| \right) \formkomma
    \end{align}
  \end{proof}
  ...
  \begin{satz}
    ...
    \begin{itemize}
      \item für alle \( \alpha\in\Omega^{0}(M) \) bzw. \( \alpha\in\Omega^{2}(M) \), dass
              \begin{align}
              \label{eqKonsistentzHodge0bzw2form}
                *\psi(\alpha) &= \psi(*\alpha)
              \end{align} \formpunkt
      \item für alle \( \alpha\in\Omega^{1}(M) \), dass
            \begin{align}
              \left\| *\psi(\alpha) - \psi(*\alpha) \right\| &\le \mathcal{O}\left( h_{\sigma^{2},\max}^{2} \right)
            \end{align}
    \end{itemize}
  \end{satz}
  \begin{proof}
    Die Aussagen folgen direkt aus Lemma \ref{lemmaKonsistenzHodge}.
    Für \( p=0 \) ist \( h_{\sigma^{p}} = 0 \), da \( \sigma^{0} \) nur aus einem Punkt besteht.
    Für \( p=2 \) ist \( |\star\sigma^{p}| = 0 \), fuck nein! ... ich geh schlafen!
  \end{proof}
