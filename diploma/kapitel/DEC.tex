...
\section{Laplace-Operator}
  ...
  \subsection{Implementierung}
    ...
    \todo[inline]{änder M als bezeichner}
  ...
  \subsection{Beispiel: Poisson-Gleichung}
    ...
    berechnet werden. \todo{evtl elem vektor noch aufschreiben}
...
\section{Primär-Dual-Gradient im Mittel}
  ...
  \( T|K| \) überhaupt stetig ist. \todo{verweis auf beispiel}
  ...
  \subsection{Beispiele}
    \begin{beispiel}[Sphäre]
      ...
      \begin{table}[htbp]
       ...
       \end{tabular}
       \caption[Gradient aud Sphäre]{Fehler des Primal-Dual-Gradienten im Mittel.}
       \label{tabGradSphere}
      \end{table}
    \end{beispiel}
