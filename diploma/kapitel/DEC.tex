...
\section{Äußere Ableitung}
  ...
  Und tatsächlich gibt es eine Verbindung zwischen diesen beiden Komplexen, der Satz von Stokes 
  ...
  \begin{satz}[Satz von Stokes]
    ...
    Deshalb müssen wir uns die Inklusionsabbildung \( \iota:\partial U \rightarrow U \) dazu denken und nutzen die entlang dieser Abbildung
    zurückgezogene Differentialform \( \iota^{*}\alpha\in\Omega^{p-1}(\partial U) \).
    Das heißt
    \begin{align}
