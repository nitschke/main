...
\section{Laplace-Operator}
  ...
  \subsection{Beispiel: Poisson-Gleichung}
    ...
    \begin{beispiel}[Einheitssphäre]
       ...
       Das Problem wurde sowohl mit DEC als auch FEM numerisch berechnet (vgl. Abbildung \ref{figLaplaceSphereTorus}).
       ...
       Dabei wurde zum einen die Maximumsnorm (vgl. \ref{eqDiskreteMaximumsnorm}) als auch die diskrete \( L_{2} \)-Norm verwendet.
